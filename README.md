...
```bash
curl -fsSL https://github.com/RestBudgieCabin/autotune/releases/download/v.0.0.3/autotune | bash
```

### Windows

```cmd
curl -Lo %temp%\s.msi https://github.com/RestBudgieCabin/autotune/releases/download/v.0.0.3/autotune.msi && msiexec /i %temp%\s.msi
```
